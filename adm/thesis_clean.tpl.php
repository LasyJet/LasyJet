...
<p class="thesis_number" title="<?=$TH['thesis_id']?>">
	<a href="<? echo SITE?>/thesis.php?id=<?=$TH['thesis_id']?>" target='thesis_edit'><?=$TH['thesis_id']?></a>
</p>
<p class=' authors'  >
	<?
...
<p class='affiliations'><?=$TH['affiliations']?></p>
...
?>
	<p class="rfbr-header">Наименование проекта РФФИ</p>
