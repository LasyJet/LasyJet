...
$session=$_GET['ses']; 
	...
	$path="merge_lifts.php";
	// echo "<p>";
	for($n=1;$n<=6; $n++){
		$r=rand();
		echo "<h2>&nbsp;<a href='$path?ses=$n&$r'> $n </a></h2><br>";
	}
	// echo "</p>";
	exit;
}
...
// echo $names;
// echo $files;
$outputFile="merged_lift_session_".$session.".pdf";// добавить номер сессии
$cmd = "gs -q -dNOPAUSE -dBATCH -sDEVICE=pdfwrite -sOutputFile=$outputFile ".$files;
// $cmd = "convert -density 150 $(ls -rt ./uploads/lift/".$session."-*.pdf) ".$outputFile;
