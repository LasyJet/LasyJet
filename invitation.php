...
if ($_SESSION['this_report_type']=='accepted'){
$text="    От имени Организационного комитета конференции ФизикА.СПб, информируем Вас о том, что Ваша работа «".$thesisTile."» принята для доклада.
...
elseif ($_SESSION['this_report_type']=='poster'){
...
elseif($_SESSION['this_report_type']=='invited'){
$text="    От имени Организационного комитета конференции ФизикА.СПб, информируем Вас о том, что Ваш доклад «".$thesisTile."» принят в качестве приглашенного. 
";
}
else $text="Произошла ошибка. Обратитесь в оргкомитет по почте mail@physica.spb.ru.";
